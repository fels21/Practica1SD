...
class COSBackend: 
    def __init__(self,res):
        ...
        self.cos_client = ibm_boto3.client('s3', aws_access_key_id=res['access_key'],
...
#GetObject
#var = cos.get_object('borjag', 'dades.txt')
#f1 = open("dades.txt", "w+")
#f1.write(var)

#HeadObject
#key = cos.head_object('borjag', 'dades.txt')
#metadata = []
#print "La mida de la clau es:" + str(metadata['ContentLenght'])

#DeleteObject
#cos.delete_object('borjag', 'dades.txt')
